public class HealthyBurger extends Hamburger {
    ...
    //we need to override this method in addition to get sum of the healthy burger with extras
    @Override
